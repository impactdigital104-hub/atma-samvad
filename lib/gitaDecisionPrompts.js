...
- summary:
  ...
  - It MUST clearly reflect THIS specific situation and emotion (as given in the user input).
  - Do NOT reuse generic phrases like "act from dharma and clarity rather than fear or short-term gain".
  - Vary your wording from case to case so that different dilemmas produce clearly different summaries.
...
- gitaLens:
  ...
  - Each bullet should clearly relate to THIS user's situation and emotion, not generic life advice.
  - Do not reuse the exact same set of bullets across different dilemmas; adjust them to the context.
...
- actionPlan:
  ...
  - Steps must be specific to this situation, not the same generic plan for every user.
  - Tie at least one step directly to one of the selected verses.
...
Below is some additional commentary / explanatory context (JSON) derived from
the user's preferred Bhagavad Gita text. When present, you may use this
commentary to deepen:
- "whyRelevant" for each verse,
- the "gitaLens" points,
- the "actionPlan" suggestions.

Do NOT copy long passages. Use it only as supporting context and keep your own
wording short and clear.
...
- the verses provided in the JSON block, and
- the optional commentary JSON (if any),
