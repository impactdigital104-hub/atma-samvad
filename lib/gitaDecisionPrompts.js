...
- verses:
  ...
  - For each verse, mention:
    - ref: the verse reference, like "BG 2.47".
    - excerpt: a short, plain-language paraphrase or key line.
...
Each verse has:
- "ref"      – a reference like "BG 2.47"
- "text"     – the verse in simple English
- "themes"   – tags about what the verse relates to
- "summary"  – a short explanation of why the verse matters in life.
...
- In the "verses" array, use the verses from the provided JSON, adapting "text" into a short "excerpt".
